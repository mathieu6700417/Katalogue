...
class Dépot:
    ...
    def gérer_sauvegarde_locale(fonction):
        def fonction_avec_sauvegarde(param, sauvegarder_localement): #TODO: gestion générique des params cas autres
            nom_dépôt = param.__class__.__name__
            nom_fonction = fonction.__name__
            chemin_sauvegarde_locale = os.path.join(param.dossier,f'locale_{nom_dépôt}_{nom_fonction}.pkl')

            if sauvegarder_localement:
